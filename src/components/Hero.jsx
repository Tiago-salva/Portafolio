...
export default function Hero() {
  return (
    <section
      id="hero"
      className="flex flex-col items-center justify-end border-blue lg:justify-center min-h-20 lg:min-h-dvh lg:p-10 fixed bg-light-white max-w-full lg:min-w-2/6 border-r-4 z-120 lg:shadow-2xl text-light-black"
    >
